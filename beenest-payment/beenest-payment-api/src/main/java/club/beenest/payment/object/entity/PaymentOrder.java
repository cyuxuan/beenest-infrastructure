...
public class PaymentOrder {
    ...
    /**
     * 关联订单计划编号
     * 对应 ds_order_plan.plan_no
     */
    @Schema(description = "关联订单计划编号", example = "PLAN202601261234567890")
     ...
     * 关联订单计划状态（查询时关联）
     */
    @Schema(description = "关联订单计划状态")
    private String planStatus;
    
    /**
     * 关联订单计划匹配状态（查询时关联）
     */
    @Schema(description = "关联订单计划匹配状态")
    ...
    public String getPaymentMethodDisplayName() {
        ...
        return switch (paymentMethod) {
            case PaymentConstants.METHOD_WECHAT_MINI -> "微信小程序";
            case PaymentConstants.METHOD_ALIPAY_MINI -> "支付宝小程序";
