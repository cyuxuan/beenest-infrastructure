package club.beenest.payment.controller.internal;
...
import club.beenest.payment.service.*;
...
public class InternalPaymentController {
    ...
    public Response<PaymentOrder> getLatestPaymentOrderByPlanNo(@PathVariable String planNo) {
        return Response.success(paymentService.getLatestPaymentOrderByPlanNo(planNo));
    }
