...
public class WalletUpdateAuditInterceptor implements Interceptor {
    ...
    private static final Set<String> ALLOWED_STATEMENTS = Set.of(
            "club.beenest.payment.mapper.WalletMapper.updateById",
            "club.beenest.payment.mapper.WalletMapper.updateStatus",
            "club.beenest.payment.mapper.WalletMapper.reconcileBalance"
    );
