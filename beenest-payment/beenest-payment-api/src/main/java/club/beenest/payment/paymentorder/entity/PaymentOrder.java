...
import club.beenest.payment.paymentorder.enums.PaymentOrderStatus;
...
public class PaymentOrder {
    ...
    /**
     * 关联业务单号（通用，由调用方传入）
     * 充值订单为null，业务订单由调用方指定（如无人机订单计划编号、商城订单编号等）
     */
    @Schema(description = "关联业务单号", example = "PLAN202601261234567890")
    private String bizNo;

    /**
     * 业务类型
     * 用于多租户隔离（如 DRONE_ORDER、SHOP_ORDER）
     */
