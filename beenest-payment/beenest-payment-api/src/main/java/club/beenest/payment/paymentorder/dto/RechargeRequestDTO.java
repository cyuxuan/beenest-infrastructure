...
public class RechargeRequestDTO {
     ...
     * DOUYIN: 抖音支付
     *
     * <p>支付方式由 `paymentMethod` 决定，默认 `WECHAT_APP` / `ALIPAY_APP` / `DOUYIN_MINI`。</p>
     */
     ...
     * 如果不指定，系统会根据平台自动选择。
     *
     * <p>微信场景下默认使用 `WECHAT_APP`，微信内 / 小程序场景可显式传 `WECHAT_JSAPI`。</p>
     */
     ...
     * 渠道用户标识（可选）。
     *
     * <p>微信 JSAPI / 小程序充值时，调用方可以直接传入已认证的 openid，
